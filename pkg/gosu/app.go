...
// against, and the grant machine. Every client it vends shares that one ceiling, so guest
...
// ResourceOwnerClient vends a client bound to one user's token, reserving against the same
